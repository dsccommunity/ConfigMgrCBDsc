...
<#
    ...
    .Parameter Enable
        Specifies if sofware inventory on clients is enabled or disabled.
        Not used in Get
#>
function Get-TargetResource
{
    ...
    if ($clientSetting)
    {
        ...
        $settings = Get-CMClientSetting -Name $ClientSettingName -Setting SoftwareInventory
        ...
        if ($settings)
        {
            ...
            if ($enabled -eq $true)
            {
                ...
                $report = switch ($settings.ReportOptions)
                {
                    '1' { 'ProductOnly' }
                    '2' { 'FileOnly' }
                    '7' { 'FullDetail' }
...
<#
    ...
    .Parameter Enable
        Specifies if software inventory for clients is enabled or disabled.

    .Parameter ReportOption
...
function Set-TargetResource
{
    ...
    (
        ...
        [Parameter()]
        [ValidateSet('ProductOnly','FileOnly','FullDetail')]
        [String]
        $ReportOption,
    ...
    try
    {
        ...
        if ($Enable -eq $true)
        {
            ...
            $defaultValues = @('Enable','ReportOption')
        ...
        {
            if ($PSBoundParameters.ContainsKey('Start') -or $PSBoundParameters.ContainsKey('ScheduleType') -or
                $PSBoundParameters.ContainsKey('RecurInterval') -or $PSBoundParameters.ContainsKey('MonthlyWeekOrder') -or
                $PSBoundParameters.ContainsKey('DayOfWeek') -or $PSBoundParameters.ContainsKey('DayOfMonth') -or
                $PSBoundParameters.ContainsKey('ReportOption'))
            {
        ...
        if ($buildingParams)
        {
            ...
            {
                Set-CMClientSettingSoftwareInventory -DefaultSetting @buildingParams
            }
            else
            {
                Set-CMClientSettingSoftwareInventory -Name $ClientSettingName @buildingParams
            }
        }
    }
    catch
    ...
    else
    {
        if ($Enable -eq $true)
        {
            ...
            $testParams = @{
                ...
                ValuesToCheck = @('Enable','ReportOption')
            }
