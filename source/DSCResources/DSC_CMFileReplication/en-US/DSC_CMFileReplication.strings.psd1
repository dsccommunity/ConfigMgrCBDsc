ConvertFrom-StringData @'
    ...
    LimitSchedNonMatch   = NOTMATCH:  Value for property 'RateLimitingSchedule' does match current state, desired settings is LimitedBeginHour: {0} LimitedEndHour: {1} LimitAvailableBandwidthPercent: {2}.
    ...
    NetworkSchedNonMatch = NOTMATCH:  Value for property 'NetworkLoadSchedule' does match current state, desired settings is LimitedBeginHour: {0} LimitedEndHour: {1}  Day: {2} Type: {3}.
