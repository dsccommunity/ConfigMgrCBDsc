...
function Set-TargetResource
{
    ...
    try
    {
        ...
        {
            if (($MaxTransferRateOffSchedule) -and ($PSBoundParameters.ContainsKey('EnableDownloadOffSchedule') -and
                $EnableDownloadOffSchedule -eq $false))
            {
                Write-Warning -Message $script:localizedData.MaxOffBits
        ...
        elseif ($state.EnableBitsMaxBandwidth -eq $true)
        {
            if ($PSBoundParameters.ContainsKey('MaxBandwidthBeginHr') -or
                $PSBoundParameters.ContainsKey('MaxBandwidthEndHr') -or
                $PSBoundParameters.ContainsKey('MaxTransferRateOnSchedule') -or
                $PSBoundParameters.ContainsKey('EnableDownloadOffSchedule') -or
                $PSBoundParameters.ContainsKey('MaxTransferRateOffSchedule'))
            {
                Write-Warning -Message $script:localizedData.DisabledExtraParams
            }
