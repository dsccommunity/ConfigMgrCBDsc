...
Describe 'ConfigMgrCBDsc - DSC_CMAccounts\Get-TargetResource' -Tag 'Get' {
    ...
    Context 'When retrieving client settings' {
        BeforeAll {
            ...
            Mock -CommandName Set-Location -ModuleName DSC_CMAccounts
        }

        It 'Should return desired result' {
            Mock -CommandName Get-CMAccount -MockWith { $cmAccounts } -ModuleName DSC_CMAccounts
        ...
        It 'Should return desired result' {
            Mock -CommandName Get-CMAccount -ModuleName DSC_CMAccounts
...
Describe 'ConfigMgrCBDsc - DSC_CMAccounts\Set-TargetResource' -Tag 'Set' {
    ...
    Context 'When Set-TargetResource runs successfully' {
        BeforeAll {
            ...
            Mock -CommandName Set-Location -ModuleName DSC_CMAccounts
            Mock -CommandName Get-CMAccount -MockWith { $cmAccounts } -ModuleName DSC_CMAccounts
            Mock -CommandName New-CMAccount -ModuleName DSC_CMAccounts
            Mock -CommandName Remove-CMAccount -ModuleName DSC_CMAccounts
        }
        ...
        It 'Should call expected commands for adding a new account' {
            ...
            Should -Invoke Set-Location -ModuleName DSC_CMAccounts -Exactly 2 -Scope It
            Should -Invoke Get-CMAccount -ModuleName DSC_CMAccounts  -Exactly 1 -Scope It
            Should -Invoke New-CMAccount -ModuleName DSC_CMAccounts -Exactly 1 -Scope It
            Should -Invoke Remove-CMAccount -ModuleName DSC_CMAccounts -Exactly 0 -Scope It
        }
        ...
        It 'Should call expected commands for removing an existing account' {
            ...
            Should -Invoke Set-Location -ModuleName DSC_CMAccounts -Exactly 2 -Scope It
            Should -Invoke Get-CMAccount -ModuleName DSC_CMAccounts -Exactly 1 -Scope It
            Should -Invoke New-CMAccount -ModuleName DSC_CMAccounts -Exactly 0 -Scope It
            Should -Invoke Remove-CMAccount -ModuleName DSC_CMAccounts -Exactly 1 -Scope It
        }
    ...
    Context 'When running Set-TargetResource should throw' {
        ...
        It 'Should throw when an error is returned from New-CMAccount' {
            Mock -CommandName New-CMAccount -MockWith { throw 'error' } -ModuleName DSC_CMAccounts
        ...
        It 'Should throw when an error is returned from Remove-CMAccount' {
            Mock -CommandName Remove-CMAccount -MockWith { throw 'error' } -ModuleName DSC_CMAccounts
