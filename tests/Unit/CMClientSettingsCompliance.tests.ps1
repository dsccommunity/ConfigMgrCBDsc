...
try
{
    InModuleScope $script:dscResourceName {
        ...
        Describe 'ConfigMgrCBDsc - DSC_CMClientSettingsCompliance\Get-TargetResource' -Tag 'Get' {
            ...
            Context 'When retrieving Client Policy Settings for Compliance' {

                It 'Should return desired results when client settings exist' {
                    Mock -CommandName Get-CMClientSetting -MockWith { $clientReturn }
                    Mock -CommandName Get-CMClientSetting -MockWith { $complianceReturn } -ParameterFilter { $Setting -eq 'ComplianceSettings' }
                    ...
                    $result.EnableUserDataAndProfile | Should -Be -ExpectedValue $true
                ...
                It 'Should return desired result when client setting policy does not exist' {
                    ...
                    $result.EnableUserDataAndProfile | Should -Be -ExpectedValue $null
                ...
                It 'Should return desired result when client setting policy exist but compliance settings is not configured' {
                    Mock -CommandName Get-CMClientSetting -MockWith { $clientReturn }
                    Mock -CommandName Get-CMClientSetting -MockWith { $null } -ParameterFilter { $Setting -eq 'ComplianceSettings' }
        ...
        Describe 'ConfigMgrCBDsc - DSC_CMClientSettingsCompliance\Set-TargetResource' -Tag 'Set' {
            BeforeAll {
                ...
                Mock -CommandName Set-CMClientSettingComplianceSetting
                Mock -CommandName Import-ConfigMgrPowerShellModule
                Mock -CommandName Set-Location
            }
            ...
            Context 'When Set-TargetResource runs successfully' {
                ...
                It 'Should call expected commands when settings match' {
                    ...
                    Assert-MockCalled Set-CMClientSettingComplianceSetting -Exactly -Times 0 -Scope It
                }
                ...
                It 'Should call expected commands when settings do not match' {
                    ...
                    Assert-MockCalled Set-CMSchedule -Exactly -Times 0 -Scope It
                    Assert-MockCalled New-CMSchedule -Exactly -Times 0 -Scope It
                    Assert-MockCalled Set-CMClientSettingComplianceSetting -Exactly -Times 1 -Scope It
                }
            ...
            Context 'When running Set-TargetResource should throw' {
                BeforeEach {
                    ...
                    $clientTypeError = 'Client Settings for Compliance settings only applies to Default and Device client settings.'
        ...
        Describe 'ConfigMgrCBDsc - DSC_CMClientSettingsCompliance\Test-TargetResource' -Tag 'Test' {
            ...
            Context 'When running Test-TargetResource' {
                ...
                It 'Should return desired result true when settings match and specifying device policy and setting a schedule' {
                    Mock -CommandName Get-TargetResource -MockWith { $returnPresentDevice }

                    Test-TargetResource @inputDeviceSchedule | Should -Be $true
                }
            }
        }
    }
